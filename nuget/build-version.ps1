...
sv glass_ct_lib "Glass.ChangeTracking\lib\portable-windows8+net45"
...
mkdir $glass_ct_lib -ErrorAction SilentlyContinue
...
Copy-Item ..\Source\Glass.ChangeTracking\bin\Release\Glass.ChangeTracking.dll $glass_ct_lib
